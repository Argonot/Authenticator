...
public class UserServiceTest extends AbstractBusinessSpringContextTest {
    ...
    public void testSubscribeUser() {
        assertNotNull(userService.subscribe(subscribingUser, FORGE_APP_AUID, USER_ROLE_RUID, LOCAL_AUTHENTICATOR_URL));
    }
    ...
    public void testUserAvatarUrlStructure() {
        ...
        assertEquals(EXPECTED_USER_AVATAR_URL, subscribingUserForAvatar.getAvatar());
    }
